...
class Basic_Information(models.Model):
    ...
    photo2 = models.ImageField(upload_to=upload_to)
    photo3 = models.ImageField(upload_to=upload_to)
    photo4 = models.ImageField(upload_to=upload_to)
    photo5 = models.ImageField(upload_to=upload_to)
    ...
    # Caste = models.CharField(choices= ,max_length=120)
    # Sub-Caste
    # Gothram
    # Lagnam
    # Raasi
